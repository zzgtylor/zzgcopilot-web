...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const items: NavItem[] = [
    ...
    { href: '/admin/pages', label: '页面管理', icon: '📄', show: managesAll },
    ...
    { href: '/admin/tags', label: '标签管理', icon: '🔖', show: managesAll },
    { href: '/admin/navigation', label: '导航菜单', icon: '🧭', show: managesAll },
    { href: '/admin/templates', label: '内容模板', icon: '🧩', show: managesAll },
