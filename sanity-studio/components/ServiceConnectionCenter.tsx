...
export function ServiceConnectionCenter() {
  ...
  return <Box padding={5}><Stack space={6}>
    ...
    <Card padding={4} radius={3} border><Flex align="center" justify="space-between" gap={4} wrap="wrap"><Stack space={2}><Heading size={1}>配置入口</Heading><Text size={1} muted>文章和首页样式在 Sanity 中编辑；网站运行在 Vercel，数据使用 Neon，备份使用 Vercel Blob 和 GitLab。</Text></Stack><Flex gap={2} wrap="wrap"><Button as="a" href="/structure/site-settings" text="网站设置" mode="ghost" /><Button as="a" href="https://vercel.com/" target="_blank" text="Vercel 控制台" tone="primary" /></Flex></Flex></Card>
  </Stack></Box>
}
